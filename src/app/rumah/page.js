    ...
    <div className="p-8 max-w-6xl mx-auto">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {rumahList.map(r => (
            <div key={r.id} className="bg-[#1A1A1F] rounded-xl overflow-hidden border-gray-800 hover:border-yellow-400 transition">
              <img src={r.gambar || 'https://placehold.co/600x400'} alt={r.judul} className="w-full h-48 object-cover"/>
              <div className="p-4">
