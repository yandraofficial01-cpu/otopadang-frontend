  ...
  return (
    <main className="min-h-screen bg-[#0B0B0F] text-white">
      <section className="container mx-auto max-w-7xl px-4 py-20 text-center">
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.5 }} className="mt-16 flex flex-col items-center text-gray-500"><p className="text-sm mb-2">Geser ke bawah</p><motion.svg animate={{ y: [0, 10, 0] }} transition={{ duration: 1.5, repeat: Infinity }} className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 14l-7 7m0 0l-7-7m7 7V3" /></motion.svg></motion.div>
      </section>
