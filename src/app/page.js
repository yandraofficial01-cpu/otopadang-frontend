  ...
  return (
    <main className="min-h-screen bg-[#0B0B0F] text-white">
      <section className="container mx-auto max-w-7xl px-4 py-20 text-center">
        ...
        <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.4 }} className="text-gray-400 mt-4 text-lg max-w-2xl mx-auto">
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.5 }} className="mt-16 flex flex-col items-center text-gray-500">
