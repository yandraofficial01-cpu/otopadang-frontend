    ...
    <main className="min-h-screen bg-[#0B0B0F] text-white">
      ...
      <section className="container mx-auto max-w-7xl px-4 py-20 text-center">
        ...
        <motion.div
          ...
          className="mt-8 flex gap-4 justify-center relative">
          <div className="relative">
            <Link href="/mobil" className={`px-8 py-3 bg-yellow-500 text-black font-bold rounded-lg hover:bg-yellow-400 hover:shadow-[0_0_20px_rgba(234,179,8,0.4)] transition-all duration-300 ${activeBtn === 'mobil'? 'scale-95' : 'scale-100'}`}>
              Cari Mobil
            </Link>
            {activeBtn === 'mobil' && <CursorPointer />}
          </div>
          <div className="relative">
            <Link href="/rumah" className={`px-8 py-3 border-2 border-yellow-400 text-yellow-400 font-bold rounded-lg hover:bg-yellow-400 hover:text-black hover:shadow-[0_0_20px_rgba(234,179,8,0.4)] transition-all duration-300 ${activeBtn === 'rumah'? 'scale-95' : 'scale-100'}`}>
              Cari Rumah
            </Link>
        ...
        >
          ...
          <motion.svg animate={{ y: [0, 10, 0] }} transition={{ duration: 1.5, repeat: Infinity }} className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {/* LIST MOBIL TERBARU - HORIZONTAL SCROLL */}
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-4">
                      ...
                      <button onClick={() => pesanWA(m, 'mobil')} className="w-full mt-4 bg-green-600 hover:bg-green-500 text-white font-bold py-2 px-4 rounded-lg transition active:scale-95">
                        Hubungi via WA
                      </button>
                    </div>
                  </motion.div>
      ...
      {/* LIST RUMAH TERBARU - HORIZONTAL SCROLL */}
      <section className="container mx-auto max-w-7xl px-4 py-16">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-4">
                      ...
                      <button onClick={() => pesanWA(r, 'rumah')} className="w-full mt-4 bg-green-600 hover:bg-green-500 text-white font-bold py-2 px-4 rounded-lg transition active:scale-95">
